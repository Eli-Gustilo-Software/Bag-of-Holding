...
import com.eligustilo.thebagofholding.*
import java.util.*
            ...
            itemDetailsConfirmButton.setOnClickListener {
                if (newItemName != null && newItemEffect != null) {//item exists
                    when (newItemType) {//TODO should these be enums
                        "weapon" -> { //Weapon
                            val name: String = newItemName ?: ""
                            val newWeapon = WeaponItemData((R.drawable.item_sword_icon), newItemName ?: "<unknown name>", newItemEffect?: "<unknown effect>", newItemDescription?: "", UUID.randomUUID())
                        ...
                        "armor" -> { //Armor/Apparel
                            val newArmor = ArmorItemData((R.drawable.item_helmet_icon), newItemName?: "<unknown name>", newItemEffect?: "<unknown effect>", newItemDescription?: "", UUID.randomUUID())
                            val character = DataMaster.retrieveCharacterInformation()
                            if (character != null) {
                        ...
                        "consumable" -> { //Consumable
                            val newConsumable = ConsumablesItemData((R.drawable.item_potion_icon), newItemName?: "<unknown name>", newItemEffect?: "<unknown effect>", newItemDescription?: "", UUID.randomUUID())
                            val character = DataMaster.retrieveCharacterInformation()
                            if (character != null) {
                        ...
                        "misc" -> { //Miscellaneous
                            val newMisc = MiscellaneousItemData((R.drawable.item_misc_icon), newItemName?: "<unknown name>", newItemEffect?: "<unknown effect>", newItemDescription?: "", UUID.randomUUID())
                            val character = DataMaster.retrieveCharacterInformation()
                            if (character != null) {
